...
use Untek\Utility\CodeGenerator\CodeGeneratorDatabase\Application\Handlers\GenerateDatabaseCommandHandler;
...
return static function (ContainerConfigurator $configurator): void {
    ...
    $services
        ->load('Untek\Utility\CodeGenerator\CodeGeneratorDatabase\\', __DIR__ . '/../../..')
        ->exclude([
