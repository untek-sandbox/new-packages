...
use Untek\Utility\CodeGenerator\CodeGeneratorRestApi\Application\Handlers\GenerateRestApiCommandHandler;
...
return static function (ContainerConfigurator $configurator): void {
    ...
    $services
        ->load('Untek\Utility\CodeGenerator\CodeGeneratorRestApi\\', __DIR__ . '/../../..')
        ->exclude([
