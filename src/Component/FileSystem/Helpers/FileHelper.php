...
//    public static $mimeAliasesFile = '@yii/helpers/mimeAliases.php';
    ...
    /*public static function getMimeType($file, $magicFile = null, $checkExtension = true)
    {
        ...
        if ($magicFile !== null) {
            $magicFile = \Untek\Component\FileSystem\Helpers\FileHelper::getAlias($magicFile);
        }
...
//    private static $_mimeAliases = [];
    ...
    /*protected static function loadMimeAliases($aliasesFile)
    {
        ...
        $aliasesFile = \Untek\Component\FileSystem\Helpers\FileHelper::getAlias($aliasesFile);
